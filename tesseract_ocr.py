# -*- coding: utf-8 -*-
"""
Created on Mon May 30 15:58:22 2022
...
pdf_path = r"C:\Users\Jonnalagadda\Downloads\CG_0a2898ab-ed08-4029-b860-b8c470af27d7_1778814.pdf"
poppler_path = r"C:\New folder\poppler-22.04.0\Library\bin"
...
df = df.drop(["level","page_num","par_num","block_num","conf",
   ...
   #y = pytesseract.image_to_boxes(adjusted)
Quantity = []
vat_price =[]
